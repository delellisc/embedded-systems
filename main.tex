...
\section{Exam - 03/11/2025}
Exam took place this monday and had most of the questions being based in basic digital electronics. Transistors, relays, pull down and pull up resistors, microcontrollers, Arduino code.

% -----|-----|-----|-----|-----|-----|-----|-----|-----|-----

\section{Lecture - 06/11/2025}
Content taught: Soldering, running code on Arduino Nano

% -----|-----|-----|-----|-----|-----|-----|-----|-----|-----

\section{Lecture - 10/11/2025}
Content taught: Exercise of a circuit project. Temperature sensor.
